...
<tr>
<td>Employee Name::</td>
<td><frm:input path="ename" class="form-control"/><p class="text-danger"><frm:errors path="ename" /></p></td>
</tr>
<tr>
<td>Employee job::</td>
<td><frm:input path="job" class="form-control"/><p class="text-danger"><frm:errors path="job" /></p></td>
</tr>
<tr>
<td>Employee sal::</td>
<td><frm:input path="sal" class="form-control"/><p class="text-danger"><frm:errors path="sal" /></p></td>
</tr>
<tr>
