...
<c:choose>
	<c:when test="${!empty empsList}">
		...
		<table class="table table-hover w-75 m-auto table-bordered">
...
<a class="text-decoration-none" href="./"><img alt="not load" src="images/home.jpg" width="40px" height="40px">Home</a>
</div>
</div>